...
const teamMembers = [
  { name: "Jason Leo", role: "Co-Founder", image: imgAvatar1 },
  { name: "Sofia Mendes", role: "Designer", image: imgAvatar2 },
  { name: "Liam Chen", role: "Marketing & Growth", image: imgAvatar3 },
  { name: "Ethan Ross", role: "Lead Engineer", image: imgAvatar4 },
];

const differentials = [
  { title: "Inovação", desc: "Inovação constante em cada pixel e linha de código." },
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <h1 className="font-['Audiowide',cursive] text-[clamp(32px,5vw,56px)] text-white uppercase tracking-[-0.03em] leading-[1.15] mb-8 drop-shadow-lg">
            AMIGOS, EXPERTS E{" "}
            <span className="text-[#d7f20d]">PARCEIROS</span>:{" "}
            <br className="hidden md:block" />
            ISSO É O QUE <span className="text-[#d7f20d]">SOMOS</span>
          </h1>

          <p className="text-white/50 font-['Geist',sans-serif] text-[clamp(16px,2vw,20px)] max-w-2xl mx-auto leading-relaxed mb-10">
            Mais do que uma agência, somos um movimento. Um grupo de amigos unindo criatividade e engenharia para construir experiências digitais que somam resultados reais ao seu negócio.
          </p>
        </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="font-['Audiowide',cursive] text-white text-[clamp(28px,4vw,40px)] uppercase tracking-tight leading-[1.2]">
                NASCIDOS NA <span className="text-[#d7f20d]">INTERNET</span>, CRIADOS PARA INOVAR.
              </h2>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 30 }}
                ...
                >
                  <div className="backdrop-blur-xl bg-white/[0.03] border border-white/10 rounded-2xl overflow-hidden relative hover:border-[#d7f20d]/30 transition-colors">
                    ...
                    <div className="p-5 relative -mt-12 z-10">
                      ...
                      <p className="text-[#d7f20d]/60 font-['Geist',sans-serif] text-[13px] mt-1">{member.role}</p>

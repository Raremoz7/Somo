import svgPaths from "./svg-eleijerfhi";
...
export default function Frame() {
  return (
    <div className="relative size-full">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex items-center justify-center left-[calc(50%+0.29px)] size-[772.981px] top-[calc(50%+0.24px)]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "154.15625" } as React.CSSProperties}>
